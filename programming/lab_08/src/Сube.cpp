...
void rubiks_cube::RIGHT() {
    ...
    std::vector<int> mem_2 = {3, 7, 11, 4};
    UD(mem, mem_2, 3, temp_degree);
}

void rubiks_cube::RIGHT_R() {
    std::vector<int> mem = {0, 4, 7, 3};
    std::vector<int> mem_2 = {3, 4, 11, 7};
    UD(mem, mem_2, 3, -temp_degree);
}

void rubiks_cube::LEFT() {
    std::vector<int> mem = {1, 2, 6, 5};
    std::vector<int> mem_2 = {1, 6, 9, 5};
    UD(mem, mem_2, 2, temp_degree);
}

void rubiks_cube::LEFT_R() {
    std::vector<int> mem = {1, 5, 6, 2};
    std::vector<int> mem_2 = {1, 5, 9, 6};
    UD(mem, mem_2, 2, -temp_degree);
}

void rubiks_cube::UP() {
    std::vector<int> mem = {0, 4, 5, 1};
    std::vector<int> mem_2 = {0, 4, 8, 5};
    LR(mem, mem_2, 1, -temp_degree);
}

void rubiks_cube::UP_R() {
    std::vector<int> mem = {0, 1, 5, 4};
    std::vector<int> mem_2 = {0, 5, 8, 4};
    LR(mem, mem_2, 1, temp_degree);
}
